<template>
  <div class="cart-summary glass-card p-6 lg:sticky lg:top-24">
    <h3 class="text-lg font-bold text-slate-100 mb-1">Order Summary</h3>
    <p class="text-xs text-slate-500 mb-6">{{ itemCount }} item{{ itemCount > 1 ? 's' : '' }} in your order</p>
    ...
    <div class="space-y-3">
      ...
      <div class="flex items-center justify-between text-sm">
        ...
        <span class="text-emerald-400 font-semibold text-xs uppercase tracking-wider">Free</span>
      </div>

      <div class="my-3 border-t border-white/5" />

      <div class="flex items-baseline justify-between">
        <span class="text-slate-100 font-bold text-base">Total</span>
    ...
    <div class="mt-6 space-y-2.5">
      ...
      <div class="text-center text-xs text-slate-600 pt-2">or</div>
