      ...
      >
        ...
        <div class="px-3 py-2 border-b border-slate-200 dark:border-white/[0.06]">
          ...
          >
            ...
            <svg v-if="isDark" class="w-4 h-4 text-purple-600 dark:text-purple-400" fill="none" stroke="currentColor"
        ...
        <div class="px-3 py-2">
          ...
          >
            ...
            <svg v-if="prefs.locale === 'en'" class="w-4 h-4 text-purple-600 dark:text-purple-400" fill="none"
          ...
          >
            ...
            <svg v-if="prefs.locale === 'vi'" class="w-4 h-4 text-purple-600 dark:text-purple-400" fill="none"
                 stroke="currentColor" stroke-width="3" viewBox="0 0 24 24">
              <path d="m4.5 12.75 6 6 9-13.5" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
          </button>
