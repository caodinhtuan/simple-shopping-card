<template>
  ...
  >
    ...
    <div class="p-7" :class="popular ? 'pt-12' : ''">
      ...
      <p class="text-slate-500 text-xs mb-6 leading-relaxed min-h-[2.75rem]">{{ plan.description }}</p>
      ...
      <div class="space-y-2.5">
        ...
        >
          <div class="flex items-center justify-center gap-2">
            ...
            <span class="text-xs">{{ t('subs.subscribe_stripe') }}</span>
          </div>
        </n-button>
        ...
        >
          <div class="flex items-center justify-center gap-2">
            ...
            <span class="text-xs">{{ t('subs.subscribe_paypal') }}</span>
          </div>
        </n-button>
      </div>
    </div>
